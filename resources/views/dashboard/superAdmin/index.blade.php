...
@section('content')
    <!-- Header -->
    <div class="header bg-primary pb-6 mb-7">
                ...
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb bsuperAdminreadcrumb-links breadcrumb-dark">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Total Number of schools</h5>
                                        <span class="h2 font-weight-bold mb-0"> {{ $schools }}</span>
                                    </div>
                                    <div class="col-auto">
                                        <i class="fa fa-graduation-cap display-4 text-warning"></i>
                                    </div>
                                </div>
                        ...
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <i class="fa  fa-user-plus display-4 text-primary"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <i class="fa fa-child display-4 text-danger"></i>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h2 font-weight-bold mb-0">{{$session->session ?? 'No session added yet'}}</span>
                                    </div>
                                    <div class="col-auto">
